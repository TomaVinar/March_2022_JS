...
for (const simpson of simpsons) {
    ...
    heroSection.classList.add('member');

    heroName.innerText = simpson.name + simpson.surname;
    heroAge.innerText = simpson.age;
    description.innerText = simpson.info;

    picture.setAttribute('src', simpson.photo)
    console.log(heroSection);

    heroSection.append(heroName, heroAge, description, picture);
...
for (const coursesArrayElement of coursesArray) {
    ...
    monthDuration.style.margin = '30px';
    ...
    for (const module of coursesArrayElement.modules) {
        ...
        modules.append(listItem);
    }
    mainBlock.append(name, monthDuration, hourDuration, modules);
